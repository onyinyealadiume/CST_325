...
function createScene() {
    ...
    var rotation = new Matrix4().makeRotationX(-89);
    ...
    // todo #4 - scale and translate the sphere
     ...
     var scalesphere = new Matrix4().makeScale(0.01, 0.01, 0.01);
...
function updateAndRender() {
    ...
    var osi= Math.sin(time.secondsElapsedSinceStart);
    // todo #4 - change color for the sphere
    if(osi=>0&&osi<=1){
    gl.uniform4f(colorProgram.uniforms.colorUniform, osi, osi-10, osi, 1.0);
    }
