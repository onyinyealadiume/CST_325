...
var Matrix4 = function(x, y, z) {
  ...
  Matrix4.prototype = {
    ...
    // -------------------------------------------------------------------------
    createMoonMatrix: function(currentRotationAngle, offmakeFromEarth, earthTransform) {
      var translation = new Matrix4().makeTranslation(offmakeFromEarth);
      var rotation = new Matrix4().makeRotationZ(currentRotationAngle);
      var moonTransform = rotation.clone().multiply(translation);
      return earthTransform.multiply(moonTransform);
    }
  };
